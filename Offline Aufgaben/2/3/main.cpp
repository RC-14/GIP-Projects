...
int main() {
	...
	cout << "Kandidat 1 erhielt " << float(kandidat1) / summe * 100 << "\% der Stimmen." << endl;
	cout << "Kandidat 2 erhielt " << float(kandidat2) / summe * 100 << "\% der Stimmen." << endl;
	cout << "Kandidat 3 erhielt " << float(kandidat3) / summe * 100 << "\% der Stimmen." << endl;
	return 0;
}
