...
TEST_CASE("Zeichenkette suchen, Text mit Laenge groesser 1, Zeichenkette mit Laenge groesser 1") {
	REQUIRE(zeichenkette_suchen_rekursiv("abcdabcdef", "cda") == 2);
	REQUIRE(zeichenkette_suchen_rekursiv("abcdabcdef", "cde") == 6);
	REQUIRE(zeichenkette_suchen_rekursiv("abcdabcdef", "de") == 7);
	REQUIRE(zeichenkette_suchen_rekursiv("abcdabcdef", "dex") == -1);
	REQUIRE(zeichenkette_suchen_rekursiv("abcdabcdef", "xyz") == -1);
	REQUIRE(zeichenkette_suchen_rekursiv("abcdabcdef", "abcdabcd") == 0);
	REQUIRE(zeichenkette_suchen_rekursiv("abcdabcdef", "abcdabcdx") == -1);
}
...
// Die fuenf vorgegebenen Testlaeufe muessen von Ihnen als REQUIRE(...) 
// innerhalb dieses einen Testcases programmiert werden ...
